...
public class UnitOfWork : IUnitOfWork, IDisposable
{
    ...
    public UnitOfWork(ApplicationDbContext context, Lazy<ICourseRepository> courseRepository, Lazy<IModuleRepository> moduleRepository, Lazy<IProjActivityRepository> projActivityRepository)
    {
